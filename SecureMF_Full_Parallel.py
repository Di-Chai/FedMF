...
from multi_threads import multipleProcess


def user_update(ShareQueue, Locker, single_user_vector, parameterList, user_rating_list, encrypted_item_vector):
...
if __name__ == '__main__':
    ...
    for iteration in range(max_iteration):
        ...
        data_result = multipleProcess(distributeList=user_vector, partitionDataFunc=partitionFunc, taskFunction=task,
